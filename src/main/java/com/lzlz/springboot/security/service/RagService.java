...
public class RagService {
    ...
    public String generatePaperQuestionIds(
        ...
        String system = """
                ...
                2. 若上一版试卷题目 ID 列表非空，请结合「上一轮教师要求」「本轮教师要求」判断意图：
                   - 若本轮更像在已有试卷上增删改（如去掉/增加/替换若干题、调整难度），则在上一版试卷基础上修改，不能扩展到整个题库。
                   - 若本轮更像重新出一套新试卷（如全新题量/题型/章节/考核范围，与上一版无明显延续关系），则忽略上一版，按本轮要求从零组卷。
                3. 若上一版试卷题目 ID 列表为空，则按本轮要求从零组卷。
